...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Health District'), array('action' => 'edit', $healthDistrict['HealthDistrict']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Health District'), array('action' => 'delete', $healthDistrict['HealthDistrict']['id']), null, __('Are you sure you want to delete # %s?', $healthDistrict['HealthDistrict']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($healthDistrict['Unity'])):?>
	...
	<?php
		$i = 0;
		foreach ($healthDistrict['Unity'] as $unity): ?>
		<tr>
