<div class="healthDistricts index">
	<h2><?php echo __('Health Districts');?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $healthDistrict['HealthDistrict']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $healthDistrict['HealthDistrict']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $healthDistrict['HealthDistrict']['id']), null, __('Are you sure you want to delete # %s?', $healthDistrict['HealthDistrict']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('New Health District'), array('action' => 'add')); ?></li>
