...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Deletar unidade'), array('action' => 'delete', $this->Form->value('Unity.id')), null, __('Deseja realmente deletar a unidade #%s?', $this->Form->value('Unity.name'))); ?></li>
		...
		<li><?php echo $this->Html->link(__('Novo unidade unidade_setor'), array('controller' => 'unity_sectors', 'action' => 'add')); ?> </li>
	</ul>
</div>
