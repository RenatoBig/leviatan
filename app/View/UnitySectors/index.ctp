<div class="unitySectors index">
	<h2><?php echo __('Unity Sectors');?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $unitySector['UnitySector']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $unitySector['UnitySector']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $unitySector['UnitySector']['id']), null, __('Are you sure you want to delete # %s?', $unitySector['UnitySector']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
