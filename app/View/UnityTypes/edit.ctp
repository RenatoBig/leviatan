...
<?php echo $this->Form->create('UnityType');?>
	<fieldset>
		<legend><?php echo __('Edit Unity Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UnityType.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UnityType.id'))); ?></li>
