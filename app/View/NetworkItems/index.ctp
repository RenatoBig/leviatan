<div class="span2 actions">
	<ul class="nav nav-list">
		...
		<li><?php echo $this->Html->link(__('Jogar na rede'), array('controller'=>'network_items', 'action' => 'items'), array('class'=>'btn')); ?></li>
...
<div class="span10 index">
	...
	foreach ($items as $key=>$item): ?>
		<tr id="trItem_<?php echo $key?>">
			...
			<td>				
				<?php echo $this->Form->postLink('Retirar da rede', array('controller' => 'network_items', 'action' => 'delete', $item['NetworkItem']['id']), array('class'=>'btn btn-danger')); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</tbody>
