<div class="span2">
	...
	<?php 
		if(in_array($item['Item']['id'], $cart_items)){ 
			...
			echo $this->Form->postLink('Adicionar ao meu carrinho', array('controller'=>'cart_items', 'action'=>'add', $item['Item']['id']), array('class'=>'btn btn-primary'));
		} 
		?>
</div>
<div class="span6 well">
	...
	<div style="padding-top:10px;">
		<?php echo $this->Html->link('Voltar', array('controller'=>'solicitation_items', 'action'=>'index'), array('class'=>'btn btn-primary'))?>
	</div>
</div>		
